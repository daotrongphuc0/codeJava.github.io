...
public class CauHinhDTO  extends BaseDTO{
    ...
    private AdminDTO nguoiTao;
    
    private ArrayList<ThueDuocKhaiDTO> thueDuocKhais;
	...
	public AdminDTO getNguoiTao() {
		return nguoiTao;
	}

	public void setNguoiTao(AdminDTO nguoiTao) {
		this.nguoiTao = nguoiTao;
	}

	public ArrayList<ThueDuocKhaiDTO> getThueDuocKhais() {
		return thueDuocKhais;
	}

	public void setThueDuocKhais(ArrayList<ThueDuocKhaiDTO> thueDuocKhais) {
		this.thueDuocKhais = thueDuocKhais;
	}
